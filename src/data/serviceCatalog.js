...
const nails = {
  pl: [
    ...
    { id: "nail-removal", name: "Usunięcie stylizacji", price: "20 €", duration: "ok. 40 min", text: "Bezpieczne zdjęcie starej stylizacji i przygotowanie paznokci." },
  ...
  en: [
    ...
    { id: "nail-removal", name: "Removal", price: "20 €", duration: "approx. 40 min", text: "Safe removal of old styling and nail preparation." },
  ...
  nl: [
    ...
    { id: "nail-removal", name: "Verwijderen", price: "20 €", duration: "ca. 40 min", text: "Veilig verwijderen van oude styling en voorbereiding van de nagels." },
