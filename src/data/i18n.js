...
const pricingPL = {
  ...
  lead: "Cennik jest podzielony na trzy spokojne sekcje: zabiegi twarzy, paznokcie i stopy oraz program regularnej pielęgnacji. Dzięki temu łatwiej znaleźć usługę bez przewijania długiej listy.",
  tabs: { face: "Zabiegi twarzy", nails: "Paznokcie i stopy", care: "Programy pielęgnacji" },
...
const pricingEN = {
  ...
  lead: "The price list is divided into three calm sections: facial treatments, nails and feet, and regular care programs. This makes it easier to find the right service without scrolling through a long list.",
  tabs: { face: "Facial treatments", nails: "Nails & feet", care: "Care programs" },
...
const pricingNL = {
  ...
  lead: "De prijslijst is verdeeld in drie rustige onderdelen: gezichtsbehandelingen, nagels en voeten, en regelmatige verzorgingsprogramma's. Zo vind je makkelijker de juiste dienst zonder lange lijsten.",
  tabs: { face: "Gezichtsbehandelingen", nails: "Nagels & voeten", care: "Verzorgingsprogramma's" },
...
export const translations = {
  pl: {
    ...
    home: {
      ...
      offerTitle: "Twarz, paznokcie i przejrzysty cennik w jednym miejscu.",
      offerText: "W jednym miejscu znajdziesz pielęgnację twarzy, paznokcie, edukację skóry i programy regularnej pielęgnacji — bez presji, spokojnie i świadomie.",
    },
    treatments: {
  ...
  en: {
    ...
    home: {
      ...
      offerTitle: "Face, nails and a clear price list in one place.", offerText: "Here you will find facial care, nails, skin education and regular care programs — calmly, consciously and without pressure.",
    },
    treatments: {
