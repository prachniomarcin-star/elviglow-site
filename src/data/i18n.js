...
const offersPL = {
  facial: [
    ...
    },
    {
      ...
      includes: ["Przygotowanie skóry", "Praca nad porami i nierówną strukturą", "Maska lub wykończenie dobrane do skóry"],
  ...
  premium: [
    {
      ...
      includes: ["Przygotowanie skóry", "Ampułka dobrana do potrzeb skóry", "Maska pielęgnacyjna"],
...
const offersEN = {
  facial: [
    ...
    },
    {
      ...
      includes: ["Skin preparation", "Work on pores and uneven texture", "Mask or finish matched to skin needs"],
  ...
  premium: [
    {
      ...
      includes: ["Skin preparation", "Ampoule matched to skin needs", "Care mask"],
...
const offersNL = {
  facial: [
    ...
    },
    {
      ...
      includes: ["Voorbereiding van de huid", "Werk aan poriën en ongelijkmatige structuur", "Masker of finish afgestemd op de huid"],
  ...
  premium: [
    {
      ...
      includes: ["Voorbereiding van de huid", "Ampul afgestemd op huidbehoefte", "Verzorgend masker"],
