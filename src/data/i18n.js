...
const waxingPL = {
  groups: [
    {
      title: "Twarz i precyzyjne miejsca",
      text: "Delikatne obszary, gdzie liczy się dokładność, komfort i spokojne wykończenie skóry.",
      items: ["Wąsik", "Broda", "Baczki / policzki", "Regulacja brwi woskiem", "Cała twarz bez brwi"],
    },
    {
      title: "Ciało",
      text: "Większe partie ciała, przy których ważna jest równa aplikacja, higiena i gładki efekt.",
      items: ["Pachy", "Ręce do łokcia", "Całe ręce", "Łydki", "Uda", "Całe nogi", "Linia brzucha", "Brzuch", "Dolne plecy"],
    },
    {
      title: "Bikini i okolice intymne",
      text: "Zakres depilacji dobieramy indywidualnie: od klasycznej linii bikini po pełniejszą depilację intymną.",
      items: ["Bikini klasyczne", "Bikini extended", "Brazilian", "Hollywood", "Pośladki", "Linia pośladków"],
    },
  ],
  prices: [
    { category: "Twarz", items: [
      { name: "Wąsik", price: "10 €", text: "Szybkie wygładzenie delikatnej okolicy nad ustami." },
      { name: "Broda", price: "10 €", text: "Precyzyjna depilacja pojedynczego obszaru twarzy." },
      { name: "Wąsik + broda", price: "17 €", text: "Połączenie dwóch najczęściej wybieranych miejsc na twarzy." },
      { name: "Baczki / policzki", price: "15 €", text: "Wygładzenie bocznych partii twarzy lub policzków." },
      { name: "Regulacja brwi woskiem", price: "15 €", text: "Szybkie oczyszczenie linii brwi i nadanie bardziej zadbanego kształtu." },
      { name: "Cała twarz bez brwi", price: "35 €", text: "Dla osób, które chcą delikatnie wygładzić kilka obszarów twarzy podczas jednej wizyty." },
    ]},
    { category: "Ciało", items: [
      { name: "Pachy", price: "18 €", text: "Gładkość i świeże uczucie bez codziennego golenia." },
      { name: "Ręce do łokcia", price: "25 €", text: "Depilacja przedramion dla estetycznego, lekkiego efektu." },
      { name: "Całe ręce", price: "35 €", text: "Pełna depilacja rąk." },
      { name: "Łydki", price: "30 €", text: "Najczęściej wybierany zakres depilacji nóg." },
      { name: "Uda", price: "30 €", text: "Wygładzenie górnej części nóg." },
      { name: "Całe nogi", price: "50 €", text: "Pełna depilacja nóg dla dłuższego uczucia gładkości." },
      { name: "Linia brzucha", price: "12 €", text: "Precyzyjna depilacja wąskiej linii na brzuchu." },
      { name: "Brzuch", price: "25 €", text: "Depilacja większego obszaru brzucha." },
      { name: "Dolne plecy", price: "25 €", text: "Wygładzenie dolnej części pleców." },
    ]},
    { category: "Bikini", items: [
      { name: "Bikini klasyczne", price: "25 €", text: "Oczyszczenie klasycznej linii bikini." },
      { name: "Bikini extended", price: "35 €", text: "Szerszy zakres niż bikini klasyczne, dobierany spokojnie przed zabiegiem." },
      { name: "Brazilian", price: "45 €", text: "Depilacja intymna z pozostawieniem wybranego, małego obszaru." },
      { name: "Hollywood", price: "55 €", text: "Pełna depilacja intymna." },
      { name: "Pośladki", price: "25 €", text: "Depilacja pośladków jako osobny obszar lub dodatek do bikini." },
      { name: "Linia pośladków", price: "15 €", text: "Precyzyjny dodatek do depilacji bikini lub Hollywood." },
    ]},
  ],
};
...
const waxingEN = {
  groups: [
    { title: "Face and precise areas", text: "Small, delicate areas where precision, comfort and calm finishing matter.", items: ["Upper lip", "Chin", "Sideburns / cheeks", "Eyebrow waxing", "Full face without brows"] },
    { title: "Body", text: "Larger body areas where even application, hygiene and a smooth result are important.", items: ["Underarms", "Half arms", "Full arms", "Lower legs", "Thighs", "Full legs", "Stomach line", "Stomach", "Lower back"] },
    { title: "Bikini and intimate areas", text: "The range is chosen individually: from a classic bikini line to fuller intimate waxing.", items: ["Classic bikini", "Extended bikini", "Brazilian", "Hollywood", "Buttocks", "Buttock line"] },
  ],
  prices: [
    { category: "Face", items: [
      { name: "Upper lip", price: "10 €", text: "A quick smooth finish for the delicate area above the lip." },
      { name: "Chin", price: "10 €", text: "Precise waxing of one facial area." },
      { name: "Upper lip + chin", price: "17 €", text: "A combination of the two most commonly chosen facial areas." },
      { name: "Sideburns / cheeks", price: "15 €", text: "Smoothing the side areas of the face or cheeks." },
      { name: "Eyebrow waxing", price: "15 €", text: "Cleaning the brow line and giving a more groomed shape." },
      { name: "Full face without brows", price: "35 €", text: "For clients who want to smooth several facial areas in one visit." },
    ]},
    { category: "Body", items: [
      { name: "Underarms", price: "18 €", text: "A smoother, fresher feeling without daily shaving." },
      { name: "Half arms", price: "25 €", text: "Forearm waxing for a clean, light result." },
      { name: "Full arms", price: "35 €", text: "Full arm waxing." },
      { name: "Lower legs", price: "30 €", text: "The most commonly chosen leg waxing area." },
      { name: "Thighs", price: "30 €", text: "Smoothing the upper legs." },
      { name: "Full legs", price: "50 €", text: "Full leg waxing for a longer smooth feeling." },
      { name: "Stomach line", price: "12 €", text: "Precise waxing of a narrow stomach line." },
      { name: "Stomach", price: "25 €", text: "Waxing a larger stomach area." },
      { name: "Lower back", price: "25 €", text: "Smoothing the lower back." },
    ]},
    { category: "Bikini", items: [
      { name: "Classic bikini", price: "25 €", text: "Cleaning the classic bikini line." },
      { name: "Extended bikini", price: "35 €", text: "A wider range than classic bikini, chosen calmly before the treatment." },
      { name: "Brazilian", price: "45 €", text: "Intimate waxing with a small chosen area left." },
      { name: "Hollywood", price: "55 €", text: "Full intimate waxing." },
      { name: "Buttocks", price: "25 €", text: "Buttock waxing as a separate area or bikini add-on." },
      { name: "Buttock line", price: "15 €", text: "A precise add-on to bikini or Hollywood waxing." },
    ]},
  ],
};
...
const waxingNL = {
  groups: [
    { title: "Gezicht en precieze zones", text: "Kleine, gevoelige zones waar precisie, comfort en een rustige afwerking belangrijk zijn.", items: ["Bovenlip", "Kin", "Bakkebaarden / wangen", "Wenkbrauwen waxen", "Hele gezicht zonder wenkbrauwen"] },
    { title: "Lichaam", text: "Grotere zones waarbij gelijkmatig werken, hygiëne en een glad resultaat belangrijk zijn.", items: ["Oksels", "Halve armen", "Hele armen", "Onderbenen", "Bovenbenen", "Hele benen", "Buiklijn", "Buik", "Onderrug"] },
    { title: "Bikini en intieme zones", text: "De omvang kiezen we individueel: van klassieke bikinilijn tot vollere intieme waxing.", items: ["Bikini klassiek", "Bikini extended", "Brazilian", "Hollywood", "Billen", "Bilnaad"] },
  ],
  prices: [
    { category: "Gezicht", items: [
      { name: "Bovenlip", price: "10 €", text: "Snel gladmaken van de delicate zone boven de lip." },
      { name: "Kin", price: "10 €", text: "Precieze waxing van één gezichtszone." },
      { name: "Bovenlip + kin", price: "17 €", text: "Combinatie van twee vaak gekozen zones in het gezicht." },
      { name: "Bakkebaarden / wangen", price: "15 €", text: "Glad maken van de zijkant van het gezicht of de wangen." },
      { name: "Wenkbrauwen waxen", price: "15 €", text: "De wenkbrauwlijn netjes maken en meer vorm geven." },
      { name: "Hele gezicht zonder wenkbrauwen", price: "35 €", text: "Voor klanten die meerdere gezichtsgebieden in één bezoek willen gladmaken." },
    ]},
    { category: "Lichaam", items: [
      { name: "Oksels", price: "18 €", text: "Een gladder en frisser gevoel zonder dagelijks scheren." },
      { name: "Halve armen", price: "25 €", text: "Waxing van de onderarmen voor een schoon, licht resultaat." },
      { name: "Hele armen", price: "35 €", text: "Volledige waxing van de armen." },
      { name: "Onderbenen", price: "30 €", text: "De meest gekozen zone voor benen waxen." },
      { name: "Bovenbenen", price: "30 €", text: "Glad maken van de bovenbenen." },
      { name: "Hele benen", price: "50 €", text: "Volledige waxing van de benen voor langer glad gevoel." },
      { name: "Buiklijn", price: "12 €", text: "Precieze waxing van een smalle lijn op de buik." },
      { name: "Buik", price: "25 €", text: "Waxing van een groter buikgebied." },
      { name: "Onderrug", price: "25 €", text: "Glad maken van de onderrug." },
    ]},
    { category: "Bikini", items: [
      { name: "Bikini klassiek", price: "25 €", text: "Netjes maken van de klassieke bikinilijn." },
      { name: "Bikini extended", price: "35 €", text: "Meer dan klassieke bikini, rustig gekozen voor de behandeling." },
      { name: "Brazilian", price: "45 €", text: "Intieme waxing met een klein gekozen deel dat blijft." },
      { name: "Hollywood", price: "55 €", text: "Volledige intieme waxing." },
      { name: "Billen", price: "25 €", text: "Waxing van de billen als aparte zone of aanvulling op bikini." },
      { name: "Bilnaad", price: "15 €", text: "Precieze aanvulling op bikini of Hollywood waxing." },
    ]},
  ],
};
...
const pricingPL = {
  ...
  waxingIntro: "Depilacja woskiem Lycon dla kobiet: twarz, pachy, ręce, nogi, bikini oraz wybrane partie ciała. Zakres dobieramy spokojnie przed wizytą.",
...
const pricingEN = {
  ...
  waxingIntro: "Lycon waxing for women: face, underarms, arms, legs, bikini and selected body areas. The range is chosen calmly before the visit.",
...
const pricingNL = {
  ...
  waxingIntro: "Lycon waxing voor vrouwen: gezicht, oksels, armen, benen, bikini en geselecteerde lichaamszones. De omvang kiezen we rustig vóór de afspraak.",
...
export const translations = {
  pl: {
    ...
    waxing: {
      ...
      lead: "Depilacja woskiem Lycon dla kobiet: twarz, pachy, ręce, nogi, bikini i wybrane partie ciała. Dobieramy zakres i rodzaj pracy do obszaru oraz wrażliwości skóry.",
      ...
      methodCards: [
        { title: "Miejsca precyzyjne", text: "Twarz, brwi, pachy i bikini wymagają spokojniejszej pracy oraz kontroli reakcji skóry." },
        { title: "Większe partie", text: "Nogi, ręce, brzuch i plecy wymagają równej aplikacji i higienicznego tempa pracy." },
  ...
  en: {
    ...
    waxing: { eyebrow: "Lycon waxing", title: "Smooth skin without random hair removal", lead: "Lycon waxing for women: face, underarms, arms, legs, bikini and selected body areas. We match the range and method to the area and skin sensitivity.", introTitle: "Comfort, precision and clean care", introText: "Small and delicate areas need precision, while larger areas need even rhythm and clean application. After waxing, soothing and simple aftercare matter too.", methodTitle: "How do we choose the waxing method?", methodCards: [{ title: "Precise areas", text: "Face, brows, underarms and bikini need calmer work and control of skin reaction." }, { title: "Larger areas", text: "Legs, arms, stomach and back need even application and hygienic pace." }, { title: "Intimate areas", text: "The range is agreed before the treatment, without rush and with full respect for comfort." }], groups: waxingEN.groups, beforeTitle: "Before and after waxing", before: ["Do not use strong exfoliation or irritate the skin the day before waxing.", "After waxing, avoid sauna, solarium, swimming pool and intense training for about 24 hours.", "With very sensitive skin, fresh irritation or active changes, we first choose a safe range."] },
