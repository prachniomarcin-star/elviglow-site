  ...
  microneedling: [
    {
      ...
      includes: ["Przygotowanie skóry", "Microneedling z profesjonalną ampułką Mesoestetic lub MCCM Professional", "Maska łagodząca"],
    ...
    },
    {
      ...
      includes: ["Przygotowanie skóry", "Microneedling twarzy i szyi z profesjonalną ampułką Mesoestetic lub MCCM Professional", "Maska łagodząca"],
    ...
    },
    {
      ...
      includes: ["Przygotowanie skóry", "Microneedling twarzy, szyi i dekoltu z profesjonalną ampułką Mesoestetic lub MCCM Professional", "Maska łagodząca"],
      effect: "Głębsza regeneracja i poprawa jakości skóry na większym obszarze.",
      passes: "Pakiet 4 zabiegów: 499 € | Pakiet 6 zabiegów: 719 €",
    },
  ],
};
  ...
  microneedling: [
    {
      ...
      includes: ["Skin preparation", "Microneedling with a professional Mesoestetic or MCCM Professional ampoule", "Soothing mask"],
    ...
    },
    {
      ...
      includes: ["Skin preparation", "Microneedling for face and neck with a professional Mesoestetic or MCCM Professional ampoule", "Soothing mask"],
    ...
    },
    {
      ...
      includes: ["Skin preparation", "Microneedling for face, neck and décolleté with a professional Mesoestetic or MCCM Professional ampoule", "Soothing mask"],
      effect: "Deeper regeneration and support for skin quality over a larger area.",
      passes: "Package of 4 treatments: 499 € | Package of 6 treatments: 719 €",
    },
  ],
};
  ...
  microneedling: [
    {
      ...
      includes: ["Voorbereiding van de huid", "Microneedling met een professionele ampul van Mesoestetic of MCCM Professional", "Kalmerend masker"],
    ...
    },
    {
      ...
      includes: ["Voorbereiding van de huid", "Microneedling voor gezicht en hals met een professionele ampul van Mesoestetic of MCCM Professional", "Kalmerend masker"],
    ...
    },
    {
      ...
      includes: ["Voorbereiding van de huid", "Microneedling voor gezicht, hals en decolleté met een professionele ampul van Mesoestetic of MCCM Professional", "Kalmerend masker"],
      effect: "Diepere regeneratie en ondersteuning van huidkwaliteit op een groter gebied.",
      passes: "Pakket 4 behandelingen: 499 € | Pakket 6 behandelingen: 719 €",
    },
  ],
};
...
const pricingPL = {
  ...
  nailsIntro: "Estetyczne, czyste i trwałe wykończenie dłoni oraz stóp — klasyczny manicure, hybryda / gellak i pedicure.",
...
const pricingEN = {
  ...
  nailsIntro: "Clean, aesthetic and long-lasting finishing for hands and feet — classic manicure, gel polish / gellak and pedicure.",
...
const pricingNL = {
  ...
  nailsIntro: "Schone, esthetische en langdurige afwerking voor handen en voeten — klassieke manicure, gellak en pedicure.",
...
export const translations = {
  pl: {
    ...
    home: {
      eyebrow: "Prywatne studio • Beauty • Care",
      title: "Twoja chwila pielęgnacji i blasku",
      lead: "ElviGlow to kameralne studio domowe w Deventer, działające wyłącznie po wcześniejszym umówieniu. Podczas wizyty przyjmowana jest jedna klientka, a zabieg odbywa się indywidualnie w zamkniętym gabinecie. Oferujemy pielęgnację twarzy, paznokcie i depilację woskiem Lycon.",
      cardTitle: "ElviGlow",
      cardSubtitle: "Prywatna pielęgnacja • jedna klientka na raz",
      ...
      serviceCards: [
        ...
        { title: "Paznokcie i stopy", text: "Manicure, hybryda / gellak i pedicure w czystym, kobiecym stylu ElviGlow." },
    ...
    nails: {
      ...
      lead: "Manicure, hybryda / gellak i pedicure w spokojnym stylu ElviGlow — estetycznie, czysto i kobieco.",
      ...
      services: nailsPL,
      note: "Najpierw patrzymy na kondycję płytki i skórek, potem dobieramy klasyczny manicure, hybrydę / gellak albo pedicure.",
    ...
    academy: {
      ...
      builder: {
        ...
        results: {
          glow: "Dobry start: dobierz zabieg do tego, co widzisz na skórze. Przy szybkim glow sprawdź Oxybrazję, przy nierównej strukturze Mikrodermabrazję, a przy porach i zanieczyszczeniach Oczyszczanie wodorowe.",
          premium: "Kierunek premium: rozświetlenie, maska i praca nad napięciem skóry. Sprawdź Glow Therapy z ampułką i maską albo Pielęgnację liftingującą.",
          micro: "Kierunek regeneracyjny: przy utrwalonych zmianach lub potrzebie pracy nad strukturą skóry warto omówić microneedling. Aktualne pakiety obejmują 4 albo 6 zabiegów.",
    ...
    contact: {
      ...
      cards: [
        { icon: "✦", title: "Instagram", text: "Najwygodniejsze miejsce do rezerwacji, pytań i obejrzenia aktualnych prac ElviGlow.", type: "instagram" },
  ...
  en: {
    ...
    home: {
      eyebrow: "Private studio • Beauty • Care", title: "Your moment of care and glow",
      lead: "ElviGlow is a small home-based studio in Deventer, open by appointment only. Each visit is one-to-one, with one client at a time in a closed treatment room. We offer facial care, nails and Lycon waxing with a personal approach.",
      cardTitle: "ElviGlow", cardSubtitle: "Private care • one client at a time", philosophyEyebrow: "Philosophy", philosophyTitle: "Care should not be random.",
      ...
      serviceCards: [
        ...
        { title: "Nails and feet", text: "Manicure, gel polish / gellak and pedicure in the clean, feminine ElviGlow style." },
    ...
    nails: { eyebrow: "Nails", title: "Hands that look clean, feminine and cared for", lead: "Classic manicure, gel polish / gellak and pedicure in the calm ElviGlow style — aesthetic, clean and feminine.", introTitle: "Nails are part of the first impression.", introText: "Well-groomed hands build a feeling of elegance just like radiant skin. At ElviGlow, nails can be a separate service or a complement to your beauty ritual.", services: nailsEN, note: "First we look at the condition of the nail plate and cuticles, then choose classic manicure, gel polish / gellak or pedicure.", infoTitle: "What do we do in nail care?", infoLead: "The nails page explains the available care and colour options. The full price list stays in the Prices tab.", infoCards: [{ title: "Classic manicure and gel polish", text: "For hands that should look neat, fresh and elegant every day. We match colour, shape and finish to the client’s style." }, { title: "Pedicure and feet", text: "Care for feet, nails and cuticles. It can be classic, with colour or in a more relaxing wellness version." }, { title: "Safe removal", text: "Old styling should be removed calmly and without damaging the nail plate. This matters if nails are to stay in good condition." }, { title: "Shape and colour choice", text: "Not every colour and shape suits every nail plate. We match the effect to nail length, hand shape, work and expectations." }] },
    ...
    academy: {
      ...
      builder: { title: "Mini skin map", text: "Choose answers and see an educational care direction.", ageLabel: "Age / skin stage", problemLabel: "Main concern", rhythmLabel: "Care rhythm", ageOptions: ["20–29", "30–39", "40–49", "50+", "60+"], problemOptions: ["Dryness and tiredness", "Pores and impurities", "First lines", "Loss of firmness"], rhythmOptions: ["First visit", "From time to time", "I want regularity"], results: { glow: "Choose the treatment by what you see on the skin: Oxybrasion for a quick glow, Microdermabrasion for uneven texture, or Hydrogen Cleansing for pores and impurities.", premium: "Premium direction: radiance, mask and work on firmness. Check Glow Therapy with Ampoule and Mask or Lifting Care.", micro: "Regeneration direction: for fixed changes or work on texture, microneedling can be discussed. Current packages are available for 4 or 6 treatments.", membership: "Regularity may make the most sense: a care program or series instead of random visits every few months." } },
  ...
  nl: {
    ...
    nails: { eyebrow: "Nagels", title: "Handen die schoon, vrouwelijk en verzorgd ogen", lead: "Klassieke manicure, gellak en pedicure in de rustige ElviGlow-stijl — esthetisch, schoon en vrouwelijk.", introTitle: "Nagels zijn deel van de eerste indruk.", introText: "Verzorgde handen geven een gevoel van elegantie, net als een stralende huid. Bij ElviGlow kunnen nagels een losse dienst zijn of een aanvulling op je beautyroutine.", services: nailsNL, note: "Eerst kijken we naar de conditie van de nagelplaat en nagelriemen, daarna kiezen we klassieke manicure, gellak of pedicure.", infoTitle: "Wat doen we bij nagelverzorging?", infoLead: "De nagelpagina legt de beschikbare verzorging en kleuropties uit. De volledige prijslijst blijft in de tab Prijzen.", infoCards: [{ title: "Klassieke manicure en gellak", text: "Voor handen die er dagelijks netjes, fris en elegant uitzien. We stemmen kleur, vorm en afwerking af op de stijl van de klant." }, { title: "Pedicure en voeten", text: "Verzorging van voeten, nagels en nagelriemen. Klassiek, met kleur of in een meer ontspannende wellnessversie." }, { title: "Veilig verwijderen", text: "Oude styling moet rustig en zonder schade aan de nagelplaat worden verwijderd. Dit is belangrijk voor gezonde nagels." }, { title: "Vorm en kleur kiezen", text: "Niet elke kleur en vorm past bij elke nagelplaat. We stemmen het effect af op lengte, handvorm, werk en wensen." }] },
