...
const copy = {
  pl: {
    ...
    directions: {
      glow: { title: "Kierunek Glow i Odświeżenie", short: "Skóra może potrzebować nawilżenia, rozświetlenia i lekkiego pobudzenia bez zaczynania od najmocniejszych procedur.", treatments: [["Efekt Glow", "lekki start, świeżość i glow"], ["Promienna Cera", "odświeżenie, lepszy koloryt, pielęgnacja"], ["Ampułka Glow", "mocniejsze wsparcie efektu glow"]] },
      balance: { title: "Kierunek Oczyszczenie i Równowaga", short: "Przy porach, zanieczyszczeniach albo skórze bez równowagi lepiej zacząć od spokojnego oczyszczenia, nawilżenia i oceny reakcji skóry.", treatments: [["Promienna Cera", "oczyszczająco-pielęgnujący kierunek"], ["Efekt Glow", "delikatny start przy pierwszej wizycie"], ["Cera w Równowadze", "regularne prowadzenie skóry"]] },
      lifting: { title: "Kierunek Lifting i Napięcie", short: "Jeśli pojawia się utrata jędrności, pierwsze zmarszczki albo zmęczony owal, skóra zwykle potrzebuje nie tylko nawilżenia, ale też mocniejszej pielęgnacji liftingującej.", treatments: [["Liftingująca Pielęgnacja", "napięcie i pielęgnacja anti-aging"], ["Ampułka Lifting", "mocniejsze wsparcie składnikami aktywnymi"], ["Microneedling Anti-Aging", "do omówienia przy potrzebie regeneracji"]] },
      regeneration: { title: "Kierunek Regeneracja i Struktura Skóry", short: "Przy utrwalonych zmianach, nierównej strukturze albo potrzebie mocniejszej przebudowy skóry warto omówić zabiegi regeneracyjne.", treatments: [["Microneedling Basic", "regeneracja i praca nad strukturą"], ["Microneedling Anti-Aging", "mocniejszy kierunek anti-aging"], ["Regeneracja Pro", "program miesięczny: microneedling + ampułka"]] },
      eye: { title: "Kierunek Eye Refresh", short: "Jeśli główny problem dotyczy okolicy oka, warto skupić się na delikatnym odświeżeniu, napięciu i poprawie wyglądu zmęczonego spojrzenia.", treatments: [["Eye Refresh", "okolica oka i zmęczone spojrzenie"], ["Liftingująca Pielęgnacja", "gdy problem dotyczy też napięcia twarzy"], ["Ampułka Lifting", "mocniejszy kierunek pielęgnacji"]] },
      comfort: { title: "Kierunek Komfort i Delikatna Pielęgnacja", short: "Przy skórze wrażliwej lepiej nie zaczynać od najmocniejszych zabiegów. Najpierw warto uspokoić skórę i dobrać bezpieczny rytm pielęgnacji.", treatments: [["Efekt Glow", "delikatniejszy start"], ["Promienna Cera", "do omówienia po ocenie skóry"], ["Cera w Równowadze", "regularna opieka i dopasowanie"]] },
      ...
      prevention: { title: "Kierunek Prewencja i Pierwsze Oznaki Starzenia", short: "Przy pierwszych zmarszczkach najlepiej połączyć odświeżenie skóry z regularną pielęgnacją i delikatnym kierunkiem anti-aging.", treatments: [["Liftingująca Pielęgnacja", "pierwszy kierunek anti-aging"], ["Ampułka Glow", "odżywienie i blask"], ["Glow Premium", "regularne prowadzenie skóry"]] },
    },
    packages: {
      ...
      singleOr3: ["Dobry wybór: 1 zabieg albo karnet 3", "Jeśli chodzi o szybkie odświeżenie, wystarczy pojedynczy zabieg. Jeśli problem wraca, lepszy będzie karnet 3."],
      series: ["Dobry wybór: karnet 3 lub karnet 5", "Seria ma większy sens, kiedy celem jest poprawa jakości skóry, struktury, jędrności albo dłuższe utrzymanie efektu."],
...
copy.en = {
  ...
  directions: {
    glow: { title: "Glow and Refresh Direction", short: "The skin may need hydration, radiance and gentle stimulation without starting with the strongest procedures.", treatments: [["Glow Effect", "gentle start, freshness and glow"], ["Radiant Skin", "refreshing, better tone, care"], ["Glow Ampoule", "stronger glow support"]] },
    balance: { title: "Cleansing and Balance Direction", short: "With pores, impurities or skin out of balance, it is better to start with calm cleansing, hydration and observing the skin reaction.", treatments: [["Radiant Skin", "cleansing and care direction"], ["Glow Effect", "gentle start for first visit"], ["Skin in Balance", "regular skin guidance"]] },
    lifting: { title: "Lifting and Firmness Direction", short: "If there is loss of firmness, first lines or a tired oval, the skin usually needs more than hydration — it needs a stronger lifting care direction.", treatments: [["Lifting Care", "firmness and anti-aging care"], ["Lifting Ampoule", "stronger support with active ingredients"], ["Microneedling Anti-Aging", "to discuss when regeneration is needed"]] },
    regeneration: { title: "Regeneration and Skin Texture Direction", short: "With fixed changes, uneven texture or a need for stronger skin rebuilding, regenerative treatments are worth discussing.", treatments: [["Microneedling Basic", "regeneration and texture work"], ["Microneedling Anti-Aging", "stronger anti-aging direction"], ["Regeneration Pro", "monthly program: microneedling + ampoule"]] },
    eye: { title: "Eye Refresh Direction", short: "If the main concern is the eye area, focus on gentle freshness, tension and improving the tired look.", treatments: [["Eye Refresh", "eye area and tired look"], ["Lifting Care", "when the concern also includes face firmness"], ["Lifting Ampoule", "stronger care direction"]] },
    comfort: { title: "Comfort and Gentle Care Direction", short: "For sensitive skin, it is better not to start with the strongest treatments. First calm the skin and choose a safe rhythm.", treatments: [["Glow Effect", "gentler start"], ["Radiant Skin", "to discuss after assessment"], ["Skin in Balance", "regular care and adjustment"]] },
    ...
    prevention: { title: "Prevention and First Aging Signs Direction", short: "With first lines, it is best to combine skin refreshment with regular care and a gentle anti-aging direction.", treatments: [["Lifting Care", "first anti-aging direction"], ["Glow Ampoule", "nourishment and glow"], ["Glow Premium", "regular skin guidance"]] },
  },
  packages: { single: ["Best start: 1 treatment", "A good choice for a first visit. The cosmetologist can assess the skin, choose intensity and observe the reaction."], singleOr3: ["Good choice: 1 treatment or pass 3", "For a quick refresh, one treatment can be enough. If the concern returns, a pass of 3 may be better."], series: ["Good choice: pass 3 or pass 5", "A series makes more sense when the goal is improving skin quality, texture, firmness or longer effect."], monthly: ["Good choice: Regular Care Program", "For clients who want to guide the skin systematically instead of choosing from zero every visit."] },
};
...
copy.nl = {
  ...
  directions: {
    glow: { title: "Richting Glow en Opfrissing", short: "De huid kan hydratatie, glow en zachte stimulatie nodig hebben zonder te beginnen met de sterkste procedures.", treatments: [["Glow Effect", "zachte start, frisheid en glow"], ["Stralende Huid", "opfrissing, betere teint, verzorging"], ["Ampul Glow", "sterkere ondersteuning van glow"]] },
    balance: { title: "Richting Reiniging en Balans", short: "Bij poriën, onzuiverheden of huid uit balans is het beter te starten met rustige reiniging, hydratatie en observatie van de huidreactie.", treatments: [["Stralende Huid", "reinigende verzorgingsrichting"], ["Glow Effect", "zachte start bij eerste bezoek"], ["Huid in Balans", "regelmatige huidbegeleiding"]] },
    lifting: { title: "Richting Lifting en Stevigheid", short: "Bij minder stevigheid, eerste lijntjes of een vermoeid ovaal heeft de huid vaak niet alleen hydratatie nodig, maar ook een sterkere lifting verzorging.", treatments: [["Lifting Care", "stevigheid en anti-aging verzorging"], ["Ampul Lifting", "sterkere ondersteuning met actieve ingrediënten"], ["Microneedling Anti-Aging", "te bespreken bij behoefte aan regeneratie"]] },
    regeneration: { title: "Richting Regeneratie en Huidstructuur", short: "Bij vaste veranderingen, ongelijke structuur of behoefte aan sterkere huidopbouw zijn regeneratieve behandelingen het bespreken waard.", treatments: [["Microneedling Basic", "regeneratie en structuur"], ["Microneedling Anti-Aging", "sterkere anti-aging richting"], ["Regeneratie Pro", "maandprogramma: microneedling + ampul"]] },
    eye: { title: "Richting Eye Refresh", short: "Als het grootste probleem de oogzone is, ligt de focus op zachte opfrissing, spanning en een minder vermoeide blik.", treatments: [["Eye Refresh", "oogzone en vermoeide blik"], ["Lifting Care", "wanneer het ook om gezichtsspanning gaat"], ["Ampul Lifting", "sterkere verzorgingsrichting"]] },
    comfort: { title: "Richting Comfort en Zachte Verzorging", short: "Bij gevoelige huid is het beter niet met de sterkste behandelingen te starten. Eerst kalmeren en een veilig ritme kiezen.", treatments: [["Glow Effect", "zachtere start"], ["Stralende Huid", "te bespreken na huidbeoordeling"], ["Huid in Balans", "regelmatige zorg en afstemming"]] },
    ...
    prevention: { title: "Richting Preventie en Eerste Tekenen", short: "Bij eerste lijntjes is het goed om opfrissing te combineren met regelmaat en een zachte anti-aging richting.", treatments: [["Lifting Care", "eerste anti-aging richting"], ["Ampul Glow", "voeding en glow"], ["Glow Premium", "regelmatige huidbegeleiding"]] },
  },
  packages: { single: ["Beste start: 1 behandeling", "Een goede keuze bij een eerste bezoek. De specialist kan de huid beoordelen, intensiteit kiezen en de reactie zien."], singleOr3: ["Goede keuze: 1 behandeling of kaart 3", "Voor een snelle opfrissing kan één behandeling genoeg zijn. Als het probleem terugkomt, is een kaart van 3 beter."], series: ["Goede keuze: kaart 3 of kaart 5", "Een serie heeft meer zin wanneer het doel huidkwaliteit, structuur, stevigheid of langer effect is."], monthly: ["Goede keuze: Regelmatig Verzorgingsprogramma", "Voor klanten die de huid systematisch willen begeleiden in plaats van elke keer opnieuw te kiezen."] },
};
