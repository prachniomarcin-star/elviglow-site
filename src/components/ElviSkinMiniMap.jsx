...
const copy = {
  pl: {
    ...
    directions: {
      glow: { title: "Kierunek Glow i Odświeżenie", short: "Skóra może potrzebować nawilżenia, rozświetlenia i lekkiego pobudzenia bez zaczynania od najmocniejszych procedur.", treatments: [["Oxybrazja", "delikatne odświeżenie i wygładzenie"], ["Oczyszczanie Glow", "oczyszczenie, pory i świeży wygląd"], ["Glow Therapy z ampułką i maską", "nawilżenie i mocniejsze wsparcie glow"]] },
...
copy.en = {
  ...
  directions: {
    glow: { title: "Glow and Refresh Direction", short: "The skin may need hydration, radiance and gentle stimulation without starting with the strongest procedures.", treatments: [["Oxybrasion", "gentle refresh and smoothing"], ["Cleansing Glow", "cleansing, pores and a fresher look"], ["Glow Therapy with Ampoule and Mask", "hydration and stronger glow support"]] },
    ...
    lifting: { title: "Lifting and Firmness Direction", short: "If there is loss of firmness, first lines or a tired oval, the skin usually needs more than hydration — it needs a stronger lifting care direction.", treatments: [["Lifting Care", "firmness and anti-aging care"], ["Glow Therapy with Ampoule and Mask", "nourishing care and a fresher look"], ["Microneedling — face", "to discuss when regeneration is needed"]] },
    regeneration: { title: "Regeneration and Skin Texture Direction", short: "With fixed changes, uneven texture or a need for stronger skin rebuilding, regenerative treatments are worth discussing.", treatments: [["Microneedling — face", "regeneration and texture work"], ["Microneedling — face + neck", "regeneration over a larger area"], ["Regeneration Pro", "monthly program: microneedling + ampoule"]] },
    eye: { title: "Gentle Refresh Direction", short: "If the main concern is a tired-looking eye area, it is better to start calmly: hydration, soothing and skin assessment instead of a strong procedure.", treatments: [["Glow Therapy with Ampoule and Mask", "hydration, soothing and freshness"], ["Lifting Care", "when the concern also includes facial firmness"], ["Oxybrasion", "gentle refresh after skin assessment"]] },
    comfort: { title: "Comfort and Gentle Care Direction", short: "For sensitive skin, it is better not to start with the strongest treatments. First calm the skin and choose a safe rhythm.", treatments: [["Oxybrasion", "gentler start"], ["Glow Therapy with Ampoule and Mask", "hydration and soothing after assessment"], ["Skin in Balance", "regular care and adjustment"]] },
...
copy.nl = {
  ...
  directions: {
    glow: { title: "Richting Glow en Opfrissing", short: "De huid kan hydratatie, glow en zachte stimulatie nodig hebben zonder te beginnen met de sterkste procedures.", treatments: [["Oxybrasie", "zachte opfrissing en gladheid"], ["Reiniging Glow", "reiniging, poriën en frisse uitstraling"], ["Glow Therapy met ampul en masker", "hydratatie en sterkere glow-ondersteuning"]] },
