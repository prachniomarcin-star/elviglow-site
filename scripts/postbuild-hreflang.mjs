...
const clusters = [
  {
    nl: "/gezichtsbehandeling-deventer",
    pl: "/pl/gezichtsbehandeling-deventer",
    en: "/en/gezichtsbehandeling-deventer",
  },
  {
    nl: "/huidverbetering-deventer",
    pl: "/pl/huidverbetering-deventer",
    en: "/en/huidverbetering-deventer",
  },
  {
    nl: "/microneedling-deventer",
    pl: "/pl/microneedling-deventer",
    en: "/en/microneedling-deventer",
  },
  {
    nl: "/nagels-deventer",
    pl: "/pl/nagels-deventer",
    en: "/en/nagels-deventer",
  },
  {
    nl: "/lycon-waxing-deventer",
    pl: "/pl/lycon-waxing-deventer",
    en: "/en/lycon-waxing-deventer",
  },
  {
    nl: "/oxybrasie-deventer",
    pl: "/pl/oxybrazja-deventer",
    en: "/en/oxybrasion-deventer",
  },
  {
    nl: "/waterstofreiniging-deventer",
    pl: "/pl/oczyszczanie-wodorowe-deventer",
    en: "/en/hydrogen-facial-cleansing-deventer",
  },
  {
    nl: "/kennis/waxen-eerste-keer",
    pl: "/pl/wiedza/depilacja-woskiem-pierwszy-raz",
    en: "/en/knowledge/first-time-waxing",
  },
  {
    nl: "/kennis/brazilian-wax-voorbereiden",
    pl: "/pl/wiedza/brazilian-wax-jak-sie-przygotowac",
    en: "/en/knowledge/brazilian-wax-preparation",
  },
  {
    nl: "/kennis/bikinilijn-of-brazilian-wax",
    pl: "/pl/wiedza/bikini-czy-brazilian-wax",
    en: "/en/knowledge/bikini-line-or-brazilian-wax",
  },
  {
    nl: "/kennis/hoe-lang-glad-na-waxen",
    pl: "/pl/wiedza/jak-dlugo-gladka-skora-po-depilacji-woskiem",
    en: "/en/knowledge/how-long-does-waxing-last",
  },
  {
    nl: "/kennis/grove-porien-wat-helpt",
    pl: "/pl/wiedza/rozszerzone-pory-co-pomaga",
    en: "/en/knowledge/large-pores-what-helps",
  },
  {
    nl: "/kennis/droge-huid-ondanks-creme",
    pl: "/pl/wiedza/sucha-skora-mimo-kremu",
    en: "/en/knowledge/dry-skin-despite-moisturiser",
  },
  {
  ...
  },
  {
    ...
    en: "/en/knowledge/oxybrasion-or-hydrogen-cleansing",
  },
];
...
for (const cluster of clusters) {
  ...
  for (const language of ["nl", "pl", "en"]) {
    ...
    // Remove every existing hreflang alternate so each page ends with one clean, reciprocal set.
    let html = original.replace(/\s*<link\s+rel=["']alternate["']\s+hreflang=["'][^"']+["'][^>]*\/>/gi, "");
    ...
    // Strict validation: every localized page must contain exactly one of each target.
